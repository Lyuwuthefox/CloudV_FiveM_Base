	...
	ESX.TriggerServerCallback("esx:isUserAdmin", function(admin)
		if admin then
			...
			if not DoesBlipExist(blipMarker) then
				TriggerEvent('b-notify:notify', 'error', 'Admin Teleport', 'Du hast keinen Waypoint gesetzt!')
					return 'marker'
			end
			...
			if not found then
					...
					TriggerEvent('b-notify:notify', 'success', 'Admin Teleport', 'Du hast dich zu deinem Waypoint teleportiert!')
			end
