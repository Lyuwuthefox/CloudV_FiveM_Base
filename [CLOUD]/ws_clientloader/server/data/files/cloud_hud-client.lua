...
RegisterCommand("loading", function(source, args)
    TriggerEvent("sanity:loadingbar","Verwende Medikit",6000)
end)

-- clienmt
RegisterNetEvent("sanity:announce")
AddEventHandler("sanity:announce", function(message)
    SendNUIMessage({action = 'announce', text = message, time = 14500})
end)

RegisterNetEvent("sanity:loadingbar")
AddEventHandler("sanity:loadingbar", function(message,duration)
