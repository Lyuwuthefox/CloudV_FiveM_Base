        ...
        for _, player in pairs(PlayersInSync) do
            ...
            if NetworkIsPlayerActive(player) then
                ...
                if IsEntityDead(GetPlayerPed(player)) then
                    ...
                    PlayerString = PlayerString..' | ~r~Bewusstlos~s~'
        ...
        if onSelected then
            ...
            if checkESXPerms('PlayerList_Goto') and In_Admin_Duty or AdminBypass() then
                ...
                if x == 0 and y == 0 and z == 0 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Dieser Spieler ist nicht im Sync" , 5000,"error")
        ...
        Items:AddList('Menu Theme', { 'Default', '~r~Rot~s~', '~b~Blau~s~', '~s~Weiss~s~', '~p~Lila~s~', '~o~Orange~s~', '~y~Gelb~s~', '~g~Gruen~s~', '~r~R~y~G~b~B~s~' }, ThemeIndex, 'Menu Theme', DefaultButton, function(Index, onSelected)
            ...
            if onSelected then
                ...
                if ThemeIndex == 1 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Theme geändert : Default" , 5000,"success")
                ...
                elseif ThemeIndex == 2 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Theme geändert : Rot" , 5000,"success")
                ...
                elseif ThemeIndex == 3 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Theme geändert : Blau" , 5000,"success")
                ...
                elseif ThemeIndex == 4 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Theme geändert : Weiss" , 5000,"success")
                ...
                elseif ThemeIndex == 5 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Theme geändert : Lila" , 5000,"success")
                ...
                elseif ThemeIndex == 6 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Theme geändert : Orange" , 5000,"success")
                ...
                elseif ThemeIndex == 7 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Theme geändert : Gelb" , 5000,"success")
                ...
                elseif ThemeIndex == 8 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Theme geändert : Grün" , 5000,"success")
                ...
                elseif ThemeIndex == 9 then
                    ...
                    TriggerEvent("sanity:notify", "ADMINMENU","Theme geändert : RGB" , 5000,"success")
                    TriggerEvent("sanity:notify", "RGB MODE","Dein PC hat nun 200% Mehr FPS HART COCK 8===D" , 5000,"info")
